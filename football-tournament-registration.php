...
if(isset($_POST['submit'])){
	...
	$sql1 = "SELECT * FROM `football` WHERE `team_name` = '{$teamname}'";
	...
	if(mysqli_num_rows($result_sql1) > 0){
		...
		$sql = "INSERT INTO `football`(`team_name`, `college_name`, `mobile`, `captain_name`, `player_1`, `player_2`, `player_3`, `player_4`, `player_5`, `player_6`, `player_7`, `player_8`, `player_9`, `player_10`, `status`) VALUES (
	...
	if($result){
		...
		header("Location:http://localhost/sportsEventReminder/football-tournament-registration.php?ok=1");
		exit;
...
<div class="container-fluid" id="tournament-registration-page" style="margin-top: 7%">
		...
		?>
			<h2 class="text-danger">Football Tournament Registration Form</h2>
			<!-- form input -->
