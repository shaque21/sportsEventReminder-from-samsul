...
<div class="col-sm-10 offset-sm-1 p-4">
	<div class="content ">
		<h2 class="text-primary"><i class="fa fa-key mr-1 text-primary" aria-hidden="true"></i> UPDATE PASSWORD <small class="text-secondary">Update My Profile Password</small></h2>
		...
		?>
		<div class="row">
			<div class="col-sm-10 offset-sm-1 form-section" style="">
