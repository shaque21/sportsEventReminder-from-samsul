...
<div class="col-sm-10 offset-sm-1 p-4">
	<div class="content">
		<h2 class="text-primary"><i class="fa fa-pencil-square-o mr-2 text-primary" aria-hidden="true"></i> UPDATE USER <small class="text-secondary">Update My Profile</small></h2>
		...
		<div class="row">
			<div class="col-sm-9 offset-sm-1 form-section" style="
				...
				<form action="save_edit_profile.php" method="POST" accept-charset="utf-8" enctype="multipart/form-data" style="
					...
					<div  class="form-group">
						<label style="font-weight: 600;" for="username">Mobile : </label>
						<input type="text" name="mobile" value="<?php echo $row['mobile']; ?>" placeholder="Enter Mobile Number" class="form-control" required id="mobile">
					</div>
					<div  class="form-group">
					...
					<div  class="form-group">
						<label style="font-weight: 600;" for="dob">Date Of Birth : </label>
						<input type="date" name="dob" value="<?php echo $row['dob']; ?>" placeholder="Enter date of birth" class="form-control" required id="dob">
					</div>
