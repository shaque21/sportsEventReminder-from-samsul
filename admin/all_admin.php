...
<div class="col-sm-9 p-4">
	<div class="content">
		<h2 class="text-primary"><i class="fa fa-users  mr-2" aria-hidden="true"></i>ALL ADMINS <small class="text-secondary">All Admins</small></h2>
		<nav aria-label="breadcrumb">
			<ol class="breadcrumb">
				<li class="breadcrumb-item active" aria-current="page"><i class="fa fa-users  mr-2" aria-hidden="true"></i>All Admins</li>
				...
				<li class="ml-4"><a href="registration.php"><i class="fa fa-plus-circle mr-1" aria-hidden="true"></i> Add Admin</a></li>
			</ol>
		</nav>
