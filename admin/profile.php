...
<div class="col-sm-9 p-4">
	<div class="content">
		<h2 class="text-primary"><i class="fa fa-user mr-2" aria-hidden="true"></i></i>ADMIN PROFILE <small class="text-secondary">My Profile</small></h2>
		<nav aria-label="breadcrumb">
			<ol class="breadcrumb">
				<li class="breadcrumb-item active" aria-current="page"><i class="fa fa-user mr-2" aria-hidden="true"></i>Admin Profile</li>
				<li class="ml-4"><a href="index.php"><i class="fa fa-tachometer-alt mr-1" aria-hidden="true"></i> Dashboard</a></li>
				<li class="ml-4"><a href="update_pass.php?pid=<?php echo base64_encode($_SESSION['AD_USER_ID']) ; ?>"><i class="fa fa-key mr-1" aria-hidden="true"></i> Update Password</a></li>
			</ol>
		</nav>
		<?php
